...
test("orchestration preserves the frozen task version and accepts condition-bound downgrade packs", () => {
  ...
  assert.match(service, /\["generatable", "generatable_with_downgrade"\]\.includes\(pack\.decision\)/);
  assert.ok(service.indexOf("generatable_with_downgrade") < service.indexOf("await generateFormalArticle"));
});
