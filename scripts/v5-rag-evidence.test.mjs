...
function fixture() { const chunk = { chunkId: "chunk-1", indexSnapshotId: "idx-1", namespace: "production_public", productId: "noteflow", productName: "Noteflow", knowledgeBaseIds: ["kb"], sourceId: "source-1", sourceRevisionId: "rev-1", primaryClaimId: "claim-1", claimIds: ["claim-1"], sourceLocator: { headingPath: ["能力"] }, semanticType: "claim_chunk", chunkTitle: "文档问答", summary: "基于资料回答", content: "基于资料回答并保留引用。", originalQuote: "基于资料回答并保留引用。", documentType: "official_product_page", authorityLevel: "A2", lifecycleStatus: "current", visibility: "public", supportMode: "direct", claimScope: "public_product", capabilityStatus: "current", conditions: [], limitations: [], scenarioTags: [], capabilityTags: [], audienceTags: [], problemTags: [], channelTags: [], distilledTermIds: [], questionCandidateIds: [], conflictGroupIds: [], rulePackageVersionId: "rule-1", contentHash: "a", semanticHash: "a", duplicateClusterId: "a", status: "active", chunkerVersion: "v1" }; const candidate = { chunk, channels: ["required"], rawScores: { required: 1 }, rrfScore: .1, rerankScore: .5, selected: true, exclusionReasons: [], selectionReasons: ["required"], evidenceRoles: ["product_mechanism", "method_step", "human_boundary"] }; const run = { retrievalRunId: "run-1", retrievalRequestId: "req-1", indexSnapshotIds: ["idx-1"], routeId: "route-wechat-tool-guide", routeVersion: "v1", retrievalPolicyVersion: "v1", status: "completed", candidates: [candidate], selectedChunkIds: ["chunk-1"], missingEvidenceRoles: [], startedAt: new Date().toISOString(), completedAt: new Date().toISOString() }; const request = { retrievalRequestId: "req-1", matrixItemId: "matrix-1", productId: "noteflow", productName: "Noteflow", namespace: "production_public", language: "zh-CN", title: "指南", channel: "wechat", contentType: "guide", platformContentType: "implicit_tool_guide", targetAudience: "知识工作者", sourceProblem: "资料分散", distilledTermIds: [], rulePackageVersionId: "rule-1", permissionScope: ["public"], lifecycleStatuses: ["current"], requestedAt: new Date().toISOString() }; return { run, request }; }
