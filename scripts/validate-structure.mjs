...
const requiredFiles = [
  ...
  "database/migrations/20260829_043_v5_hosted_sample_progress.sql",
  "database/migrations/20260829_044_v5_geo_research_evidence_isolation.sql",
  "database/migrations/20260830_045_v5_geo_article_mission_and_rubrics.sql",
  "database/migrations/20260830_046_v5_adp_csp_identity_and_strategy_cta.sql",
  "src/lib/v5/geo-article-mission-contracts.ts",
  "src/lib/v5/production-rubrics.ts",
  "scripts/v5-geo-article-mission.test.mjs",
  "scripts/run-authorized-product-sample-generation.mjs",
