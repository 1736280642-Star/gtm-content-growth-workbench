...
addAbsentCheck("v5 free production has no workspace role guard", "src/lib/v5/free-production-service.ts", [
  "currentRole",
  "WorkspaceRole",
  "FREE_PRODUCTION_FORBIDDEN",
  "PUBLISH_ROLES"
]);
addAbsentCheck("v5 free expression has no workspace role guard", "src/lib/v5/free-content-expression-type-service.ts", [
  "currentRole",
  "WorkspaceRole",
  "FREE_CONTENT_TYPE_FORBIDDEN",
  "WRITE_ROLES"
]);
