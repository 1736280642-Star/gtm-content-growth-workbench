...
const actions = [
  ...
  { key: "upload", icon: <CloudUploadOutlined />, title: "上传知识", detail: "上传文档或网页并选择所属产品，后续治理与调研自动运行。", href: "/knowledge/import", label: "上传并绑定", primary: true },
  { key: "strategy", icon: <BookOutlined />, title: "查看自动策略", detail: "查看系统生成的问题、内容类型、矩阵和生产进度。", href: "/monthly-plan", label: "进入内容中心" },
  { key: "exception", icon: <ExceptionOutlined />, title: "处理异常", detail: "只查看证据不足、连接缺失或发布失败等需人工判断事项。", href: "/monthly-plan?step=generation", label: "查看异常" },
