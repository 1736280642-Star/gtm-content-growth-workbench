...
周计划页用于一次性确定一周内容任务。用户可以自动生成，也可以手动调整。

### 5.2 线框图

```text
+------------------------------------------------------+
| 周计划  2026-06-16 ~ 2026-06-22       [生成周计划] |
+------------------------------------------------------+
| 发布设置                                                |
| 每周发布天数：[5]                                      |
| 默认每日篇数：[3]                                      |
...
官网博客监控页用于诊断官网博客内容资产，不负责博客创作。它输出三类结果：SEO 问题、GEO 测试问题、博客候选池。
...
GEO 测试页通过 DeepSeek、豆包、ChatGPT API 批量测试 AI 是否提及 JOTO、唯客，以及是否引用官网链接。
...
| 博客候选池                            [导出候选清单] |
+------------------------------------------------------+
| 候选来源：[SEO诊断] [GEO测试] [渠道表现] [人工新增]   |
+------------------------------------------------------+
| 候选列表                                                |
| 标题建议 | 来源 | 原因 | 优先级 | 状态 | 操作          |
| ... | GEO测试 | ChatGPT 未提及 JOTO | 高 | 待接入 | 查看 |
...
周度复盘页用于把渠道表现、官网博客诊断和 GEO 测试结果汇总为下周选题建议。

### 12.2 线框图

```text
+------------------------------------------------------+
| 周度复盘  2026-06-16 ~ 2026-06-22      [生成周报]   |
+------------------------------------------------------+
| 管理层摘要                                              |
| 本周发布 15 篇，已回填 12 篇；官网博客发现 8 个候选主题 |
+------------------------------------------------------+
| 渠道执行复盘                                            |
...
| OpenAI   | GEO测试/生成 | ... | 启用 | 编辑/测试连接       |
| DeepSeek | GEO测试      | ... | 启用 | 编辑/测试连接       |
| 豆包     | GEO测试      | ... | 启用 | 编辑/测试连接       |
+------------------------------------------------------+
| Prompt 配置                                             |
| 名称 | 类型 | 渠道 | 状态 | 操作                       |
| CSDN技术解释 | 内容生成 | CSDN | 启用 | 编辑/复制          |
| GEO品牌认知 | GEO测试 | 全平台 | 启用 | 编辑/测试          |
+------------------------------------------------------+
```
